...
private const val WHATS_NEW_MESSAGE =
    "Добавили свайп по дате для переключения недель, улучшили анимацию перехода между неделями, обновили отображение типов занятий и исправили возврат из просмотра другой недели без интернета. Исправлено множество недочетов в отображении успеваемости (к примеру, экзамен без оценки не отображался)."
