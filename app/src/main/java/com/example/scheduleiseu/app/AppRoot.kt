...
private const val WHATS_NEW_MESSAGE =
    "Добавили обновление расписания свайпом вниз на главном экране, привели плашки экзаменов, зачетов, консультаций и дифзачетов к тёмно-зелёному стилю, исправили показ экзамена без оценки в успеваемости и расчёт общего среднего балла только по реально посчитанным сессиям. Кнопка выхода теперь очищает локальные данные пользователя и кэш, а окно изменений получило крестик для быстрого закрытия."
